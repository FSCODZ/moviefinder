    ...
    <nav className="bg-darkblue p-5">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-5">
          <Link href="/action-movies" className="text-yellow-400 text-xl font-semibold">
            Action
          </Link>
          <Link href="/romantic-movies" className="text-yellow-400 text-xl font-semibold">
            Romance
          </Link>
          <Link href="/comedi-movies" className="text-yellow-400 text-xl font-semibold">
            Comedy
          </Link>
